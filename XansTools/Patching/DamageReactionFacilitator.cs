	...
	internal static class DamageReactionFacilitator {
		...
		*/
		...
		internal static unsafe void Patch() {
			...
			_originalPlayerDamageTaken = XansUtils.NativeHookAttachFrom<Player_Health, CommonDamageTakenDelegate>(METHOD_PTR_FLD_NAME_PLAYER, plrDamagePatch);
			...
			_originalPlayerTAKEDAMAGE = XansUtils.NativeHookAttachFrom<Player_Health, CommonTAKEDAMAGEDelegate>(METHOD_PTR_FLD_NAME_PLAYER_TAKEDAMAGE, takedamageCalled);
