...
using static XansTools.Data.XansUtils;
...
#pragma warning disable IDE0031 // Disallowed in Unity code.
		...
		/// </summary>
		public static SLZAvatar? Avatar => RigMgr != null ? RigMgr.avatar : null;
#pragma warning restore IDE0031 // Disallowed in Unity code.
		...
		/// </summary>
		public static SLZAvatar? GetCurrentAvatar() => RigMgr != null ? RigMgr.avatar : null;
	}
}
